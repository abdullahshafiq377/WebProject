document.getElementById("add-student-btn").setAttribute("disabled","")
document.getElementById("add-student-btn").classList.add("disabled");
...
function toggleAddButton(){
    if (validRegNo && validName && validFname && validEmail && validContact && validNationality ){
        document.getElementById("add-student-btn").removeAttribute("disabled");
        document.getElementById("add-student-btn").classList.remove("disabled");
    }
    else {
        document.getElementById("add-student-btn").setAttribute("disabled","")
        document.getElementById("add-student-btn").classList.add("disabled");
